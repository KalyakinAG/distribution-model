...
Функция СвернутьРезультат() Экспорт
	КолонкиГруппировок = СтрСоединить(РаботаСМассивом.АТДМассив()
		.Дополнить(Схема.База.Измерения)
		.Дополнить(Схема.База.Реквизиты)
		.Дополнить(Схема.Таблица.Измерения)
		.Дополнить(Схема.Таблица.Реквизиты)
		.Отобразить("Элемент.Псевдоним")
		.Свернуть()
		.ВМассив(), ", ")
	;
	КолонкиСуммирования = СтрСоединить(РаботаСМассивом.АТДМассив()
		.Дополнить(Схема.База.Ресурсы)
		.Дополнить(Схема.Таблица.Ресурсы)
		.Отобразить("Элемент.Псевдоним")
		.Свернуть()
		.ВМассив(), ", ")
	;
	РезультатРаспределения.Свернуть(КолонкиГруппировок, КолонкиСуммирования);
КонецФункции
...
// Устарела. Использовать РезультатРаспределения()
Функция ВыгрузитьРезультат() Экспорт
	Возврат РезультатРаспределения.Скопировать();
КонецФункции

// Устарела. Использовать ТаблицаРаспределения()
Функция ОстатокТаблицы() Экспорт
	Возврат ТаблицаРаспределения.Скопировать();
КонецФункции

// Устарела. Использовать БазаРаспределения()
Функция ОстатокБазы() Экспорт
	Возврат БазаРаспределения.Скопировать();
КонецФункции

#КонецОбласти

Функция ТаблицаРаспределения() Экспорт
	Возврат ТаблицаРаспределения.Скопировать();
КонецФункции

Функция БазаРаспределения() Экспорт
	Возврат БазаРаспределения.Скопировать();
КонецФункции

Функция РезультатРаспределения() Экспорт
	Возврат РезультатРаспределения.Скопировать();
КонецФункции

Функция ТаблицаОтношения() Экспорт
	Возврат ТаблицаОтношения.Скопировать();
КонецФункции
